...
import java.awt.event.*;
 ...
 public class Consumer_Loan_Assistant extends JFrame implements ActionListener {
   ...
   JLabel l1,l2,l3,l4,la;
	...
	// FRAME CREATION INSIDE CONSTRUCTOR.	  
...
//        getContentPane().setBackground(Color.RED);
		...
		//creating each label boundary and fonts
...
// ALL THE LOGIC IMPLEMENTATION i.e values insertion and condition for validation
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==b1) {
            try {
				// If the interest rate is kept empty or 0% provided then  
				// two warning message will appear.
				...
				// if we want to calculate monthly payment by giving the value of no. of payments.
				...
				// if we want to calculate no. of payment by giving the value of monthly payments.
...
//            tf3.setText(null);
		...
		// enabling & disabling of the button x and colour change.
...
//javac -d . Consumer_Loan_Assistant.java
//java com.suven.consultancy.Consumer_Loan_Assistant